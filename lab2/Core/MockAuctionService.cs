...
namespace lab2.Core
{
	public class MockAuctionService //: IAuctionService
	{
        ...
        {
            Auction a1 = new Auction(1, "Guitar", "A precious antique guitar", "Esaias", 500, new DateTime(2023,10,25,10,00,00), null);
            Auction a2 = new Auction(2, "Piano", "Used by Elton John", "Robert", 3000, new DateTime(2023,10,30,15,30,00), null);
